...
export const FeatureCard = ({ icon: Icon, title, items, index = 0 }: FeatureCardProps) => (
  <motion.div
    ...
    className="card-glow rounded-xl p-7 border border-border/60 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:border-primary/40"
  >
